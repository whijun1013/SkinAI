...
import { LUVEL_ASSETS } from '../constants/assets';

export default function LuvelScreen({
  children,
  scroll = true,
  showBack = false,
  backLabel = '카메라',
    ...
    <View style={styles.base}>
      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.topBar}>
          ...
          {centerLogo ? (
            <Image source={LUVEL_ASSETS.logo} style={styles.logo} resizeMode="contain" />
          ) : (
            <View />
          )}
...
function BackgroundOrnaments({ variant, showSideLeaves }) {
  return (
    <View style={StyleSheet.absoluteFill} pointerEvents="none">
      ...
      {showSideLeaves && (
        <>
          <Image source={LUVEL_ASSETS.leafLeft} style={styles.leftLeaf} resizeMode="contain" />
          <Image source={LUVEL_ASSETS.leafRight} style={styles.rightLeaf} resizeMode="contain" />
        </>
      )}
    </View>
  );
