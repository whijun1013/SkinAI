...
export default function PermissionGuideScreen({
  ...
  const requestPermission = async (key, requester) => {
    ...
    try {
      ...
      devLog(`[Permission] ${key} result`, result);
  ...
  const handlePermissionRequest = async () => {
    devLog("[Permission] CTA pressed");
    devLog("[Permission] selectedPermissions", selectedPermissions);
    ...
    try {
      if (selectedPermissions.camera) {
        devLog("[Permission] request camera");
      ...
      if (selectedPermissions.media) {
        devLog("[Permission] request media");
      ...
      if (selectedPermissions.location) {
        devLog("[Permission] request location");
      ...
      if (selectedPermissions.notification) {
        devLog("[Permission] request notification");
      ...
      if (selectedPermissions.health) {
        devLog("[Permission] health skipped");
