...
const shadowCard = Platform.OS === "ios"
  ? { shadowColor: "#D7D0C2", shadowOpacity: 0.14, shadowRadius: s(16), shadowOffset: { width: 0, height: s(6) } }
  : { elevation: 4 };

const shadowButton = Platform.OS === "ios"
  ? { shadowColor: "#4C5D3B", shadowOpacity: 0.14, shadowRadius: s(12), shadowOffset: { width: 0, height: s(5) } }
  : { elevation: 5 };
