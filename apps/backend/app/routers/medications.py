...
def search_medications(
    ...
    skin_relevant_only: Optional[bool] = Query(False, description="Filter to show only medications with skin relevant ingredients"),
    include_inactive: bool = Query(False, description="Include inactive/cancelled medications"),
