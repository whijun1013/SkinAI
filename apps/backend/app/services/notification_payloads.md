...
Luvel notification navigation uses `notification_logs.data` as the source of truth. For sent push notifications, `notification_logs.data` and Expo Push `payload.data` must have the same structure.
...
`apps/mobile/src/luvel/utils/pushNotifications.js` reads:
...
`apps/mobile/src/luvel/screens/mypage/NotificationHistoryScreen.jsx` reads:
...
- `apps/mobile/src/luvel/utils/pushNotifications.js`
...
- Mobile resolver and display:
  - `apps/mobile/src/luvel/utils/pushNotifications.js`
  - `apps/mobile/src/luvel/screens/mypage/NotificationHistoryScreen.jsx`
...
- Mobile: a small notification contract module near `src/luvel/utils/pushNotifications.js` if more screens start sharing these values.
