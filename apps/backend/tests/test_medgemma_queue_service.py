...
class TestMedGemmaQueueService(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_get_medgemma_task_status(self, mock_get_skin_ai_result):
        ...
        mock_get_skin_ai_result.return_value = {
            "signals": {"redness": 1, "dryness": 0, "acne": 0, "barrier": 0, "wrinkles": 0},
            "photo_quality": {"overall_quality": "good"},
            "confidence": "high",
            "raw_analysis": {
                "medgemma": {
        ...
        self.assertEqual(status["photo_quality"], {"overall_quality": "good"})
        ...
        await mark_medgemma_analysis_task_done(
            task_id=int(task_id),
            result={
                "signals": {"redness": 0, "dryness": 2, "acne": 0, "barrier": 0, "wrinkles": 0},
                "photo_quality": {"overall_quality": "good"},
                "confidence": "high",
                "role": "primary_skin_visual_interpretation",
