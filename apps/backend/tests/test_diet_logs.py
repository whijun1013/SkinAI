...
class TestDietLogs(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls._previous_app_db_session_local = getattr(_app_db, "SessionLocal", None)
    ...
    def tearDownClass(cls):
        ...
        from app import database as _app_db
        if cls._previous_app_db_session_local is None:
            delattr(_app_db, "SessionLocal")
        else:
            _app_db.SessionLocal = cls._previous_app_db_session_local
    ...
    def test_custom_food_name_resolves_to_food_item_when_user_edits_food_name(
        ...
        self.assertEqual(item.custom_food_name, "엄마표 국밥")
